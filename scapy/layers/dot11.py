...
class RadioTapTLV(Packet):
    fields_desc = [
        ...
        ConditionalField(OUIField("oui", 0), lambda pkt: pkt.type == 30),
        # VendorNS
...
class RadioTap(Packet):
    ...
    fields_desc = [
        ...
        # MCS
        ConditionalField(
            ReversePadField(FlagsField("knownMCS", None, -8, _rt_knownmcs), 2),
...
class Dot11(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            ...
            lambda pkt: (pkt.type == 2 and pkt.FCfield & 3 == 3),
            # from-DS+to-DS
        ),
    ]
...
# TODO: Action, Public Action, FTM Request subtype, parsing the request,
# FTM data header, parsing the data
...
action_category = {
    ...
    7: "HT",
    8: "SA-Query",
    9: "Protected-Dult-Of-Public-Action",
    10: "WNM",
    11: "Unprotected-WNM",
    12: "TDLS",
    13: "Mesh",
...
0 Reserved
1 Successfull (some parameters might have been overridden)
...
format_and_bandwith = {
    ...
    13: "VHT-80Mhz",
    14: "VHT-80+80Mhz",
    15: "VHT-2-Separate-RF-LOs-160Mhz",
    16: "VHT-Single-RF-LO-160Mhz",
    17 - 30: "Reserved",
    31: "DMG",
    32 - 63: "Reserved",
}
...
civic_location_type = {0: "IETF-RFC-4776", 1: "Vendor-Specific", 2 - 255: "Reserved"}
...
civic_location_subelements = {
    0: "Reserved",
    1: "Originator-Requesting-STA-MAC",
    2: "Target-MAC",
    3 - 220: "Reserved",
    221: "Vendor-Specific",
    222 - 255: "Reserved",
...
class Dot11PublicAction(_Dot11EltUtils):
    ...
    fields_desc = [
        ...
        ConditionalField(ByteField("Trigger", 0), lambda pkt: pkt.category == 4),
    ]
...
# TOD Error Field
# Max TOD Error Exponent (5 Bits) | Reserved (10 Bits) | TOD Not
# Continuous (1 Bits)
...
# LCI Subelement
# Subelelent ID (1 Octet) | Length (1 Octet) | LCI field (optional) (0 or
# 16 Octet)

# LCI Field
# Latitude Uncertainty (6 Bits) | Latitude (34 Bits) | Longitude Uncertainty (6 Bits) |
# Longitude (34 Bits) | Altitude Type (4 Bits) | Altitude Uncertainty (6 Bits) |
# Altitude (30 Bits) | Datum (3 Bits)| RegLoc Agreement (1 Bits)| RegLoc DSE (1 Bits) |
# Dependent STA (1 Bits) | Version (2 Bits)

# Azimuth Report Field
# Azimuth Report Subfield
# Azimuth Report Field

# FTM-Parameter
# Element ID (1 Octet) | Length (1 Octet) | FTM Measurement Parameters (9
# Octet)
